...
All pragmatic improvments are precision preserving (form complete
...
\begin{array}{lrl}\text{ where } & \maddr_\mkont,\msto' &= \push^\mcntr_\mlab(\msto,\mkont)\end{array}
\\
...
equivalence with the previous semantics with a lock-step bisimulation,
...
\begin{lemma}[$\changep$ means change (a)]
TODO
\end{lemma}

\begin{lemma}[$\changep$ means change (b)]
TODO
\end{lemma}
