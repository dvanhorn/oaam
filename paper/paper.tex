...
To achieve this linearity for continuation, we allocate an address for the value position
...
space becomes linear and the overall complexity drops to cubic. 
This is a critical abstraction in languages with $n$-ary functions,
since otherwise the continuation space grows super-exponentially.
