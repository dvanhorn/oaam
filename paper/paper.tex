...
\caption{Relative improvements over the baseline analyzer for the
  Vardoulakis and Shivers benchmark in terms of peak memory usage, the
  rate of state transitions, and total analysis time.}
...
where:
\begin{equation*}
\varsigma_0 = \ev[^\mtcntr]{e, \varnothing, \varnothing, \kmt}\text.
\end{equation*}
