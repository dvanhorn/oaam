...
The \(\rfloor\cdot\lfloor_k\) notation denotes the truncation of a list
...
\begin{figure*}
\begin{center}
  \includegraphics[width=6.5in]{all-relative-memory.ps}

  (a) Peak memory usage

  \vspace{1em}
  \includegraphics[width=6.5in]{all-relative-speed.ps}

  (b) Rate of state transitions

  \vspace{1em}
  \includegraphics[width=6.5in]{all-relative-time.ps}
