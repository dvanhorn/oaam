...
revisited. This has negative performance and precision
consequences. We instead use a frontier-based semantics that
corresponds to the classic ``worklist'' algorithms for analysis.
...
stuttering bisimulation~\cite{clarke-stuttering} between this
...
bisimulation (WEB). WEBs are equivalent to the notion of a stuttering
