...
By cases on $w$:
 \begin{byCases}
  \case{\ev{\svar{\mvar},\menv,\msto,\mkont}}{...}
  \case{\ev{\sapp[^\mlab]{\mexpi0}{\mexpi1},\menv,\msto^*,\mkont^*}}{...}
  \case{\ev{\sif[^\mlab]{\mexpi0}{\mexpi1}{\mexpi2},\menv,\msto^*,\mkont^*}}{...}
  \otherwise{Vacuously true ($s B w$ is false).}
 \end{byCases}}
...
By cases on $w$:
 \begin{byCases}
  \case{\ev{\slit{\mlit},\menv,\msto,\mkont}}{...}
  \case{\ev{\sapp[^\mlab]{\mexpi0}{\mexpi1},\menv,\msto^*,\mkont^*}}{...}
  \case{\ev{\sif[^\mlab]{\mexpi0}{\mexpi1}{\mexpi2},\menv,\msto^*,\mkont^*}}{...}
  \otherwise{Vacuously true ($s B w$ is false).}
 \end{byCases}}
...
By cases on $w$:
 \begin{byCases}
  \case{\ev{\slam{\mvar}{\mexp},\menv,\msto,\mkont}}{...}
  \case{\ev{\sapp{\mexpi0}{\mexpi1},\menv,\msto^*,\mkont^*}}{...}
  \case{\ev{\sif[^\mlab]{\mexpi0}{\mexpi1}{\mexpi2},\menv,\msto^*,\mkont^*}}{...}
  \otherwise{Vacuously true ($s B w$ is false).}
 \end{byCases}
Thus the first case of WEB holds.}
...
By definition of $B$, $r(s) = w$. By definition of $\commit$, $r(u) = w$, thus $u B w$.
By definition of $\lessdot$, $erankt(u) < erankt(s)$.
Thus the second case of WEB holds.}
...
By definition of $B$, $w = r(s)$. By definition of $\commit$, $r(u) =
r(s) = w$. By definition of $\lessdot$, $\erankt(u) \lessdot
\erankt(s)$. Thus the second case of WEB holds.}
...
By definition of $B$, either $w = s$ (ruled out) or $w = r(s)$. By
definition of $\cmachstep$, $w \cmachstep r(u)$, satisfying the first
case of WEB.}
...
\case{
 \co{\kfn[^\mcntr_\mlab]{\maddralt,\maddr},\mval,\msto}  \cmachstep
 \ap[^\mcntr_\mlab]{\mvalx{u},\mval,\msto,\mkont}}{
  where $\mkont \in \msto(\maddr), \mvalx{u} \in \msto(\maddralt)$
...}
...
\case{
 ...
 \mcomp^{\mcntr'}(\menv',\msto',\mkont)}{
 where $\menv',\msto',\mcntr' = \bind^\mcntr_\mlab(\menv,\msto,\mvar,\mval)$
...}
...
\case{
 ...
 \co{\mkont,\mval',\msto}}{
 where $\mkont \in\msto(\maddr)$
 and $\mvalx{u} \in \force(\msto,\mval), \mval'\in\interpdelta(\mop,\mvalx{u})$
...}
\end{byCases}
